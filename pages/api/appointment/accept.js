		...
		case 'PATCH':
			try {
				...
				const msg = {
					...
					html: `<p>Dear Valued Customer,<br /><br />We have received your partial payment successfully through Gcash. Webform with the following details:<br /><br />Date filed: ${new Date().toLocaleString('en-US', { timeZone: 'Asia/Manila' })}<br /><br />Date Schedule: ${data.schedule.date}<br /><br />Time of Schedule: ${data.schedule.time}<br /><br />Service: ${data.service.name}<br /><br />Amount of Service: ${data.service.price} Pesos<br/><br /><b>Note: Bring your vaccination card and wear your facemask on the day of your appointment.</b><br /><br /><b>Dr.Jevemille Pascual - Camilon Dental Clinic</b></p>`
				}
